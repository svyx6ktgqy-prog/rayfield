...
do
	...
	local AssetBaseURL = "https://github.com/svyx6ktgqy-prog/hermex11/tree/main/assets"

	local assetFiles = {
		["BannerCustom"] = "https://github.com/svyx6ktgqy-prog/hermex11/blob/main/assets/100.png?raw=true",
